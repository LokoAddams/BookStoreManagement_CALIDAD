...
public class SalesRepositoryUpdateTests
{
    [Theory]
    [InlineData(false)]
    [InlineData(true)]
    public void Update_Should_Handle_Optional_Cancellation_Fields(bool useNullCancellationData)
    {
