        ...
        public async Task<PagedResult<Distributor>> GetPageAsync(int page, int pageSize, CancellationToken ct)
        {
            ...
            while (await reader.ReadAsync())
            {
                distributors.Add(new Distributor
                {
                    ...
                    ContactEmail = await reader.IsDBNullAsync(colum_contacEmail_index, ct) ? null : reader.GetString(colum_contacEmail_index),
                    Phone = await reader.IsDBNullAsync(colum_contacPhone_index, ct) ? null : reader.GetString(colum_contacPhone_index),
                    Address = await reader.IsDBNullAsync(colum_addres_index, ct) ? null : reader.GetString(colum_addres_index),
